            ...
            <div
                ...
                <div className="lg:flex lg:items-center">
                    ...
                    <h1 id="js-heading-one-scroll" className="leading-none relative lg:top-0.5 mt-3 lg:ml-4">
                        Digitalbyrå / Vi får dig att synas!
                    </h1>
                </div>
            </div>

            <nav
                className="hidden md:flex fixed h-[8rem] right-32 top-0 z-[60] md:ml-auto max-w-[calc(100%-30rem)] justify-end items-center text-white mix-blend-difference">
                <ul className="flex justify-end text-normal text-lg">
                    <li className="px-5 relative">
                        <a className="transition-colors duration-300 ease-in-out hover:text-gray-300" href="contact.php">Kontakta oss</a>
                    </li>
                </ul>
            </nav>

            <div
                className="fixed h-[4rem] md:h-[8rem] right-6 md:right-12 top-0 z-[70] flex justify-between items-center py-10 text-white mix-blend-difference">
                <button type="button" id="js-menu-toggler"
                ...
                <nav className="w-full flex justify-between items-center relative px-12 py-10">
                    <div id="js-menu-holder"
                        ...
                        <div className="w-full flex flex-col justify-between">
                            <div
                                className="flex-1 flex items-center max-h-full overflow-y-visible px-12 xl:pl-0 lg:pr-[5rem] 2xl:pr-[20rem]">
                                <ul id="js-menu-list"
                                    ...
                                    <li className="js-menu-item flex py-2 mt-0 last:text-2xl last:mt-5">
                                        <div className="js-menu-item--wrapper flex w-full">
                                            <Link href="case.php" className="hover:text-white text-white md:text-silver-chalice group-[.hover]:text-white">
                                                Case
                                            </Link>
                                        </div>
                                    </li>
                                    <li className="js-menu-item flex has-children group py-2 mt-0 last:text-2xl last:mt-5">
                                        <div className="js-menu-item--wrapper flex w-full">
                                            <Link href="services.php" className="hover:text-white text-white md:text-silver-chalice group-[.hover]:text-white">
                                                Tjänster
                                            </Link>
                                            <span
                                                className="js-submenu-toggler text-royal-blue ml-auto md:ml-0 md:opacity-0 pl-0 group-[.hover]:opacity-100 group-[.hover]:pl-6 transition-all duration-500 ease-in-out">
                                                <svg className="inline-block w-10 h-auto md:w-full" preserveAspectRatio="none" width="67" height="37"
                                                    viewBox="0 0 67 37" aria-hidden="true">
                                                    <use href="webImages/icons.svg#arrow-right-big">
                                                    </use>
                                                </svg>
                                            </span>
                                        </div>
                                        <div
                                            className="submenu opacity-0 md:opacity-100 flex flex-col items-center md:justify-center bg-black md:bg-transparent fixed md:absolute min-h-full w-48 text-[1.425rem] md:text-[1.625rem] left-0 md:left-full top-0 w-full p-6 md:p-8 md:p-0 whitespace-nowrap font-semibold">
                                            <div className="flex items-center md:hidden self-start pt-20">
                                                <span
                                                    className="js-submenu-close rotate-180 text-royal-blue md:opacity-0 pl-0 transition-all duration-500 ease-in-out">
                                                    <svg className="inline-block w-10 h-auto" preserveAspectRatio="none" width="67" height="37"
                                                        viewBox="0 0 67 37" aria-hidden="true">
                                                        <use href="webImages/icons.svg#arrow-right-big">
                                                        </use>
                                                    </svg>
                                            ...
                                            <ul className="w-full ml-[8rem] md:ml-0 py-0">
                                                <li className="py-1 group/item">
                                                    <Link href="#" className="hover:text-white">Analys</Link>
                                                    <span
                                                        ...
                                                        Datadrivna processer</span>
                                                </li>
                                                <li className="py-1 group/item">
                                                    <Link href="#" className="hover:text-white">Branding</Link>
                                                    <span
                                                        className="hidden lg:inline text-lg 2xl:text-xl font-normal text-white/50 opacity-0 group-hover/item:opacity-100 group-hover/item:pl-2 transition-all duration-500 ease-in-out">–
                                                        Stärk ert varumärke</span>
                                                </li>
                                                <li className="py-1 group/item">
                                                    <Link href="#" className="hover:text-white">UX /
                                                        UI design</Link>
                                                    <span
                                                        className="hidden lg:inline text-lg 2xl:text-xl font-normal text-white/50 opacity-0 group-hover/item:opacity-100 group-hover/item:pl-2 transition-all duration-500 ease-in-out">–
                                                        Design som säljer</span>
                                                </li>
                                                <li className="py-1 group/item">
                                                    <Link href="#" className="hover:text-white">Content</Link>
                                                    <span
                                                        className="hidden lg:inline text-lg 2xl:text-xl font-normal text-white/50 opacity-0 group-hover/item:opacity-100 group-hover/item:pl-2 transition-all duration-500 ease-in-out">–
                                                        Innehåll som engagerar</span>
                                                </li>
                                                <li className="py-1 group/item">
                                                    <Link href="#" className="hover:text-white">Webbutveckling</Link>
                                                    <span
                                                        className="hidden lg:inline text-lg 2xl:text-xl font-normal text-white/50 opacity-0 group-hover/item:opacity-100 group-hover/item:pl-2 transition-all duration-500 ease-in-out">–
                                                        Frontend, Backend, Fullstack</span>
                                                </li>
                                                <li className="py-1 group/item">
                                                    <Link href="#" className="hover:text-white">E-handel</Link>
                                                    <span
                                                        className="hidden lg:inline text-lg 2xl:text-xl font-normal text-white/50 opacity-0 group-hover/item:opacity-100 group-hover/item:pl-2 transition-all duration-500 ease-in-out">–
                                                        WooCommerce och Laravel</span>
                                                </li>
                                                <li className="py-1 group/item">
                                                    <Link href="#" className="hover:text-white">SEO</Link>
                                                    <span
                                                        className="hidden lg:inline text-lg 2xl:text-xl font-normal text-white/50 opacity-0 group-hover/item:opacity-100 group-hover/item:pl-2 transition-all duration-500 ease-in-out">–
                                                        Ranka högre, sälj mer</span>
                                                </li>
                                                <li className="py-1 group/item">
                                                    <Link href="#" className="hover:text-white">Growth</Link>
                                                    <span
                                                        className="hidden lg:inline text-lg 2xl:text-xl font-normal text-white/50 opacity-0 group-hover/item:opacity-100 group-hover/item:pl-2 transition-all duration-500 ease-in-out">–
                                                        Konvertera bättre</span>
                                                </li>
                                                <li className="py-1 group/item">
                                                    <Link href="#" className="hover:text-white">Förvaltning</Link>
                                                    <span
                                                        className="hidden lg:inline text-lg 2xl:text-xl font-normal text-white/50 opacity-0 group-hover/item:opacity-100 group-hover/item:pl-2 transition-all duration-500 ease-in-out">–
                                                        Snabb support och trygghet</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </li>
                                    <li className="js-menu-item flex py-2 mt-0 last:text-2xl last:mt-5">
                                        <div className="js-menu-item--wrapper flex w-full">
                                            <Link href="promise.php" className="hover:text-white text-white md:text-silver-chalice group-[.hover]:text-white">
                                                Vårt löfte
                                            </Link>
                                        </div>
                                    </li>
                                    <li className="js-menu-item flex py-2 mt-0 last:text-2xl last:mt-5">
                                        <div className="js-menu-item--wrapper flex w-full">
                                            <Link href="team.php" className="hover:text-white text-white md:text-silver-chalice group-[.hover]:text-white">
                                                Vårt team
                                            </Link>
                                        </div>
                                    </li>
                                    <li className="js-menu-item flex py-2 mt-0 last:text-2xl last:mt-5">
                                        <div className="js-menu-item--wrapper flex w-full">
                                            <Link href="contact.php" className="hover:text-white text-white md:text-silver-chalice group-[.hover]:text-white">
                                                Kontakt
                                            </Link>
                                        </div>
                                    </li>
                                    <li className="js-menu-item flex py-2 mt-0 last:text-2xl last:mt-5">
                                        <div className="js-menu-item--wrapper flex w-full">
                                            <Link href="#" className="hover:text-white text-white md:text-silver-chalice group-[.hover]:text-white">
                                                English
                                            </Link>
                                        </div>
                                    </li>
                            ...
                            <div id="js-bottom-header"
                                className="opacity-0 -translate-y-4 flex justify-between items-end pb-16 md:pb-20 px-6 md:px-12">
                                <div
                                    className="text-base md:text-lg lg:text-xl leading-relaxed md:leading-relaxed lg:leading-relaxed pt-10 -ml-8">
                                ...
                                <div className="text-lg xl:text-xl min-w-[8rem] leading-none md:pb-1.5">
                                    <span className="block mb-2 xl:mb-3">Intresserad av <br />ett samarbete</span>
                                    <Link href="#"
                                        ...
                                        <span className="pl-2">
                                            <svg className="inline-block" preserveAspectRatio="none" width="17" height="17" viewBox="0 0 17 17"
                                                aria-hidden="true">
