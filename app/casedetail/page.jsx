...
export default function casesdetail() {
  return (
    <>
        ...
        <section
          className="w-full pt-[8.3rem] px-6 lg:px-8 xl:px-12"
          style={{ background: "#374455" }}
        >
        ...
        <section
          className="w-full py-14 lg:py-20 xl:py-32"
          style={{ background: "#374455" }}
        >
          <div className="flex flex-col mx-auto md:flex-row justify-items-center px-6 lg:px-8 xl:px-12 2xl:px-8 gap-x-8 text-white max-w-7xl">
            <div className="md:w-[calc(66.6666%_-_(1.5rem))] js-animate-fadeinup">
              ...
              <div className="prose max-w-xl text-base md:text-lg font-light leading-[1.4] md:leading-[1.4] lg:leading-[1.4] text-white prose-a:text-malibu prose-a:no-underline prose-a:font-light hover:prose-a:underline prose-p:mb-[1.38em] prose-ul:text-inherit prose-ul:list-disc prose-ul:list-outside prose-strong:text-inherit">
                <p>
                  Svenska Budo &amp; Kampsportsförbundet är en
                  paraplyorganisation som samlar olika kampsporter i Sverige. De
                  erbjuder stöd och resurser för klubbar och föreningar,
                  organiserar utbildningar och tävlingar, och arbetar för att
                  främja budo och kampsport nationellt.
                </p>
                <p>
        ...
        >
          <div
            className="bg-black absolute top-0 left-0 h-[12rem] w-full"
            style={{ background: " #374455" }}
          ></div>
          ...
          <div className="w-full max-w-xl mx-auto px-6 xl:px-8 js-animate-fadeinup">
            <h3 className="mb-[0.7em] text-2xl md:text-3xl leading-tight md:leading-[1.4] font-bold text-black">
              Svenska Budo & Kampsportsförbundet: Främjar och Stödjer
              Kampsporter i Sverige
            </h3>
            ...
            <div className="prose max-w-none text-base md:text-xl font-light leading-[1.4] md:leading-[1.4] lg:leading-[1.4] text-black prose-a:text-malibu prose-a:no-underline prose-a:font-light hover:prose-a:underline prose-p:mb-[1.38em] prose-ul:text-inherit prose-ul:list-disc prose-ul:list-outside prose-strong:text-inherit">
              <p>
                ...
                klubbar och föreningar. De organiserar utbildningar och
                tävlingar, främjar budo och kampsport nationellt. Förbundet
                fokuserar också på antidopingarbete och säker idrottsutövning.
                Dessutom arrangerar de evenemang som Kampsportsgalan och
                erbjuder försäkringar och bidragsmöjligheter för medlemmar.
              </p>
            </div>
          </div>
        </section>
        <section
          className="py-14 lg:py-20 xl:py-32"
          style={{ background: "#374455" }}
        >
            ...
            <div className="py-6 md:w-1/2 w-full flex md:flex-1 md:shrink-0 lg:max-w-[28.75rem] only:mx-auto only:py-0">
              <div className="flex flex-col gap-y-3 md:gap-y-[2.37rem] my-auto text-white">
                ...
                <div className="prose max-w-none text-base md:text-xl font-light leading-[1.4] md:leading-[1.4] lg:leading-[1.4] text-white prose-a:text-malibu prose-a:no-underline prose-a:font-light hover:prose-a:underline prose-p:mb-[1.38em] prose-ul:text-inherit prose-ul:list-disc prose-ul:list-outside prose-strong:text-inherit">
                  FrejaID används för identifiering och inloggning på Svenska
                  Budo & Kampsportsförbundets hemsida. FrejaID används för att
                  ansöka om tävlingskort, administrera sitt kort samt öka
                  säkerheten vid inloggning.{" "}
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="py-6 md:w-1/2 w-full flex md:flex-1 md:shrink-0 lg:max-w-[28.75rem] only:mx-auto only:py-0">
              <div className="flex flex-col gap-y-3 md:gap-y-[2.37rem] my-auto text-white">
                ...
                <div className="prose max-w-none text-base md:text-xl font-light leading-[1.4] md:leading-[1.4] lg:leading-[1.4] text-white prose-a:text-malibu prose-a:no-underline prose-a:font-light hover:prose-a:underline prose-p:mb-[1.38em] prose-ul:text-inherit prose-ul:list-disc prose-ul:list-outside prose-strong:text-inherit">
                  ...
                  Kampsportsförbundet. Det digitala tävlingskortet går att
                  ansöka om från 13års ålder via Freja eID och det går enkelt
                  att nå och redigera från Mitt konto på hemsidan.{" "}
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="py-6 md:w-1/2 w-full flex md:flex-1 md:shrink-0 lg:max-w-[28.75rem] only:mx-auto only:py-0">
              <div className="flex flex-col gap-y-3 md:gap-y-[2.37rem] my-auto text-white">
                ...
                <div className="prose max-w-none text-base md:text-xl font-light leading-[1.4] md:leading-[1.4] lg:leading-[1.4] text-white prose-a:text-malibu prose-a:no-underline prose-a:font-light hover:prose-a:underline prose-p:mb-[1.38em] prose-ul:text-inherit prose-ul:list-disc prose-ul:list-outside prose-strong:text-inherit">
                  ...
                  sanktionsansökningar och tävlingar. Det är nu möjligt att
                  ansöka om tävlingar via hemsidan. Via Mitt konto kan tävligen
                  administreras och statistik samlas in via tävlingsrapporter
                  och läkarrapporter som skickas ut via mail.{" "}
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="py-6 md:w-1/2 w-full flex md:flex-1 md:shrink-0 lg:max-w-[28.75rem] only:mx-auto only:py-0">
              <div className="flex flex-col gap-y-3 md:gap-y-[2.37rem] my-auto text-white">
                ...
                <div className="prose max-w-none text-base md:text-xl font-light leading-[1.4] md:leading-[1.4] lg:leading-[1.4] text-white prose-a:text-malibu prose-a:no-underline prose-a:font-light hover:prose-a:underline prose-p:mb-[1.38em] prose-ul:text-inherit prose-ul:list-disc prose-ul:list-outside prose-strong:text-inherit">
                  ...
                  och säkerställer att ev. avstängningar kan ske direkt på
                  plats. All information samlas i admin och sammanställs till
                  statistik som sedan används för att rapportera in till bl.a.
                  Länsstyrelsen.{" "}
                </div>
              </div>
            </div>
          ...
          <div className="max-w-7xl px-6 xl:px-8 mx-auto md:gap-x-14 xl:gap-x-20 flex-col  lg:flex justify-center items-centermd:pr-6">
            ...
            <div className="py-6 md:py-16 mx-auto w-full flex md:flex-1 md:shrink-0 lg:max-w-[28.75rem] only:mx-auto only:py-0">
              <div className="flex flex-col gap-y-3 md:gap-y-[2.37rem] my-auto text-white">
                ...
                <div className="prose max-w-none text-base md:text-xl font-light leading-[1.4] md:leading-[1.4] lg:leading-[1.4] text-white prose-a:text-malibu prose-a:no-underline prose-a:font-light hover:prose-a:underline prose-p:mb-[1.38em] prose-ul:text-inherit prose-ul:list-disc prose-ul:list-outside prose-strong:text-inherit">
                  Hemsidan är optimerad för en responsiv design med mobil först
                  i åtanke då Mitt konto och Tävlingskortet används främst från
                  mobilläge. Pigment ser alltid till att besökaren får en
                  optimal användarupplevelse oavsett om hemsidan visas på en
